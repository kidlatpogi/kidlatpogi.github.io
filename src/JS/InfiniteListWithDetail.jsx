    ...
    <article key={title} className="project-card detail-view">
      ...
      <div className="project-body">
        ...
        <div style={{ marginTop: '1rem', display: 'flex', flexDirection: 'row', gap: '0.5rem', flexWrap: 'wrap' }}>
          ...
          {hasDownload && (
            <>
              {hasRepo && <span style={{ alignSelf: 'center', color: 'var(--text-muted, rgba(128, 128, 128, 0.7))' }}>or</span>}
          ...
          {hasVisit && (
            <>
              {(hasRepo || hasDownload) && <span style={{ alignSelf: 'center', color: 'var(--text-muted, rgba(128, 128, 128, 0.7))' }}>or</span>}
